...
# تحقق إذا كان النموذج موجودًا في المسار المحدد
...
# الأعمدة النهائية التي سيتم استخدامها في التنبؤ
final_columns = [
...
def predict():
    try:
        ...
        # تحويل الأعمدة التصنيفية إلى قيم رقمية
        ...
        prediction = int(prob >= 0.3)  # إذا كانت الاحتمالية أكثر من 0.3 سيتم اعتبارها "موافقة"، أما إذا كانت أقل، فهي "رفض"
